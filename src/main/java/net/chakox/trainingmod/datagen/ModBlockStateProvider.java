...
public class ModBlockStateProvider  extends BlockStateProvider {
    public ModBlockStateProvider(PackOutput output, ExistingFileHelper exFileHelper) {
        super(output, TrainingMod.MOD_ID, exFileHelper);
    }

    @Override
    protected void registerStatesAndModels() {
        System.out.println("ModBlockStateProvider -> registerStatesAndModels() called!");
        ...
        stairsBlock((StairBlock) ModBlocks.SAPPHIRE_STAIR.get(), blockTexture(ModBlocks.SAPPHIRE_BLOCK.get()));
        ...
        trapdoorBlockWithRenderType((TrapDoorBlock) ModBlocks.SAPPHIRE_TRAP_DOOR.get(), modLoc("block/sapphire_trap_door"), true, "cutout");
